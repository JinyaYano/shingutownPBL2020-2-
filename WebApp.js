		...
		for (buy[12] = 0; buy[12] < 2; buy[12]++) {
			...
			if(sumprice[12]>300) break;
				...
				for (buy[13] = 0; buy[13] < 2; buy[13]++) {
					if (buy[13] == 1) {
						sumprice[13] = sumprice[12] + itemprice[11];
						sumvalue[13] = sumvalue[12] + itemvalue[11];
						}
					else {
				...
				for (buy[43] = 0; buy[43] < 2; buy[43]++) {
					...
					for (buy[44] = 0; buy[44] < 2; buy[44]++) {
						...
						if(sumprice[44]>300) break;
											...
											if (sumprice[45] <= 300 && maxvalue < sumvalue[45]) {
												maxvalue = sumvalue[45];
												maxprice = sumprice[45];
												for (var i = 0; i < 45; i++) {
													maxbuy[i] = buy[i];
